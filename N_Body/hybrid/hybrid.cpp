//
// Created by Tomasz Michalik on 6/3/18. - Running on MPI hybrid OpenMP
#include <math.h>
#include <stdio.h>
#include <stdlib.h>
#include <assert.h>
...
{  // print function in submatrix and convert ASCII format
    ...
    int globalsizes[2] = {nBodies_per_rank*nprocs*nIters, 0}; // * iters too
...
int main(int argc, char* argv[]) {
    ...
    for (int iter = 0; iter < counter; iter++) {
        ...
        if (myrank ==0) {printf("***Outer loop iter:%d rank%d\n", iter, myrank);}
